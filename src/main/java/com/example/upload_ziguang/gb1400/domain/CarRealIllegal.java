...
@ToString
@NoArgsConstructor
@TableName(value = "car_real_illegal")
public class CarRealIllegal implements Serializable {
     ...
     * 处理完成图片
     */
    @TableField(value = "finish1")
    private String finish1;

    /**
     * 处理完成图片
     */
    @TableField(value = "finish2")
    private String finish2;

    /**
     * 处理完成图片
     */
    @TableField(value = "finish3")
    ...
    public static final String COL_FINISH1 = "finish1";

    public static final String COL_FINISH2 = "finish2";

    public static final String COL_FINISH3 = "finish3";
}